...
public sealed partial class GuardianSystem : EntitySystem
{
    ...
    public void ToggleGuardian(Entity<GuardianHostComponent> ent) // Trauma - made public
    {
        ...
        TransformComponent? guardianXform = null)
    {
        ...
        {
            _transform.SetCoordinates(guardian, guardianXform, hostXform.Coordinates);
        }
        else
        {
            ...
            var newDiff = diff.Normalized() * guardian.Comp.DistanceAllowed;
            _transform.SetLocalPosition(guardian, hostPos + newDiff, guardianXform);
        }
        // <Trauma>
    }
